...
func AccessKeyID(v int) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldAccessKeyID, v))
}
...
func AccessKeyIDEQ(v int) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldAccessKeyID, v))
}

// AccessKeyIDNEQ applies the NEQ predicate on the "access_key_id" field.
func AccessKeyIDNEQ(v int) predicate.Category {
	return predicate.Category(sql.FieldNEQ(FieldAccessKeyID, v))
}

// AccessKeyIDIn applies the In predicate on the "access_key_id" field.
func AccessKeyIDIn(vs ...int) predicate.Category {
	return predicate.Category(sql.FieldIn(FieldAccessKeyID, vs...))
}

// AccessKeyIDNotIn applies the NotIn predicate on the "access_key_id" field.
func AccessKeyIDNotIn(vs ...int) predicate.Category {
	return predicate.Category(sql.FieldNotIn(FieldAccessKeyID, vs...))
}

// AccessKeyIDIsNil applies the IsNil predicate on the "access_key_id" field.
func AccessKeyIDIsNil() predicate.Category {
	return predicate.Category(sql.FieldIsNull(FieldAccessKeyID))
}

// AccessKeyIDNotNil applies the NotNil predicate on the "access_key_id" field.
func AccessKeyIDNotNil() predicate.Category {
	return predicate.Category(sql.FieldNotNull(FieldAccessKeyID))
}
...
func HasAccesskeys() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAccesskeysWith(preds ...predicate.AccessKeys) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
