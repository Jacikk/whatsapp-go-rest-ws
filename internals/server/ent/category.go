...
func (e CategoryEdges) AccesskeysOrErr() (*AccessKeys, error) {
	if e.Accesskeys != nil {
...
func (*Category) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case category.FieldID, category.FieldAccessKeyID:
	...
	for i := range columns {
		...
		case category.FieldAccessKeyID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				c.AccessKeyID = new(int)
				*c.AccessKeyID = int(value.Int64)
			}
		default:
...
// QueryAccesskeys queries the "accesskeys" edge of the Category entity.
func (c *Category) QueryAccesskeys() *AccessKeysQuery {
	return NewCategoryClient(c.config).QueryAccesskeys(c)
}
