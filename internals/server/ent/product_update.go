...
func (pu *ProductUpdate) SetAccessKeyID(i int) *ProductUpdate {
	pu.mutation.SetAccessKeyID(i)
	return pu
}

// SetNillableAccessKeyID sets the "access_key_id" field if the given value is not nil.
func (pu *ProductUpdate) SetNillableAccessKeyID(i *int) *ProductUpdate {
	if i != nil {
		pu.SetAccessKeyID(*i)
	}
	return pu
...
func (pu *ProductUpdate) ClearAccessKeyID() *ProductUpdate {
	pu.mutation.ClearAccessKeyID()
	return pu
}
...
func (pu *ProductUpdate) SetAccesskeysID(id int) *ProductUpdate {
	pu.mutation.SetAccesskeysID(id)
	return pu
}

// SetNillableAccesskeysID sets the "accesskeys" edge to the AccessKeys entity by ID if the given value is not nil.
func (pu *ProductUpdate) SetNillableAccesskeysID(id *int) *ProductUpdate {
	if id != nil {
		pu = pu.SetAccesskeysID(*id)
	}
	return pu
}

// SetAccesskeys sets the "accesskeys" edge to the AccessKeys entity.
func (pu *ProductUpdate) SetAccesskeys(a *AccessKeys) *ProductUpdate {
	return pu.SetAccesskeysID(a.ID)
}
...
func (pu *ProductUpdate) ClearAccesskeys() *ProductUpdate {
	pu.mutation.ClearAccesskeys()
	return pu
}
...
func (pu *ProductUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.AccesskeysCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
	...
	if nodes := pu.mutation.AccesskeysIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   product.AccesskeysTable,
...
// SetAccessKeyID sets the "access_key_id" field.
func (puo *ProductUpdateOne) SetAccessKeyID(i int) *ProductUpdateOne {
	puo.mutation.SetAccessKeyID(i)
	return puo
}

// SetNillableAccessKeyID sets the "access_key_id" field if the given value is not nil.
func (puo *ProductUpdateOne) SetNillableAccessKeyID(i *int) *ProductUpdateOne {
	if i != nil {
		puo.SetAccessKeyID(*i)
	}
	return puo
}

// ClearAccessKeyID clears the value of the "access_key_id" field.
func (puo *ProductUpdateOne) ClearAccessKeyID() *ProductUpdateOne {
	puo.mutation.ClearAccessKeyID()
	return puo
}
...
// SetAccesskeysID sets the "accesskeys" edge to the AccessKeys entity by ID.
func (puo *ProductUpdateOne) SetAccesskeysID(id int) *ProductUpdateOne {
	puo.mutation.SetAccesskeysID(id)
	return puo
}

// SetNillableAccesskeysID sets the "accesskeys" edge to the AccessKeys entity by ID if the given value is not nil.
func (puo *ProductUpdateOne) SetNillableAccesskeysID(id *int) *ProductUpdateOne {
	if id != nil {
		puo = puo.SetAccesskeysID(*id)
	}
	return puo
}

// SetAccesskeys sets the "accesskeys" edge to the AccessKeys entity.
func (puo *ProductUpdateOne) SetAccesskeys(a *AccessKeys) *ProductUpdateOne {
	return puo.SetAccesskeysID(a.ID)
}
...
// ClearAccesskeys clears the "accesskeys" edge to the AccessKeys entity.
func (puo *ProductUpdateOne) ClearAccesskeys() *ProductUpdateOne {
	puo.mutation.ClearAccesskeys()
	return puo
}
...
func (puo *ProductUpdateOne) sqlSave(ctx context.Context) (_node *Product, err error) {
	...
	if puo.mutation.AccesskeysCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   product.AccesskeysTable,
	...
	if nodes := puo.mutation.AccesskeysIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   product.AccesskeysTable,
