...
type ProductEdges struct {
	...
	// Accesskeys holds the value of the accesskeys edge.
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ProductEdges) AccesskeysOrErr() (*AccessKeys, error) {
	if e.Accesskeys != nil {
		return e.Accesskeys, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: accesskeys.Label}
	}
	return nil, &NotLoadedError{edge: "accesskeys"}
}
...
func (*Product) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case product.FieldID, product.FieldCategoryID, product.FieldAccessKeyID:
	...
	for i := range columns {
		...
		case product.FieldAccessKeyID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				pr.AccessKeyID = new(int)
				*pr.AccessKeyID = int(value.Int64)
			}
		default:
...
// QueryAccesskeys queries the "accesskeys" edge of the Product entity.
func (pr *Product) QueryAccesskeys() *AccessKeysQuery {
	return NewProductClient(pr.config).QueryAccesskeys(pr)
}
