...
// The AccessKeysFunc type is an adapter to allow the use of ordinary
// function as AccessKeys mutator.
type AccessKeysFunc func(context.Context, *ent.AccessKeysMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AccessKeysFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AccessKeysMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AccessKeysMutation", m)
}
