...
func (cc *CategoryCreate) SetAccessKeyID(i int) *CategoryCreate {
	cc.mutation.SetAccessKeyID(i)
	return cc
}

// SetNillableAccessKeyID sets the "access_key_id" field if the given value is not nil.
func (cc *CategoryCreate) SetNillableAccessKeyID(i *int) *CategoryCreate {
	if i != nil {
		cc.SetAccessKeyID(*i)
	}
	return cc
...
func (cc *CategoryCreate) SetAccesskeysID(id int) *CategoryCreate {
	cc.mutation.SetAccesskeysID(id)
	return cc
}

// SetNillableAccesskeysID sets the "accesskeys" edge to the AccessKeys entity by ID if the given value is not nil.
func (cc *CategoryCreate) SetNillableAccesskeysID(id *int) *CategoryCreate {
	if id != nil {
		cc = cc.SetAccesskeysID(*id)
	}
	return cc
}

// SetAccesskeys sets the "accesskeys" edge to the AccessKeys entity.
func (cc *CategoryCreate) SetAccesskeys(a *AccessKeys) *CategoryCreate {
	return cc.SetAccesskeysID(a.ID)
}
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.AccesskeysIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
